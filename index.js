...
try {
    ...
    const baseUrl = 'https://example.com/'                // core.getInput('base-url');
    //const excludeFiles = ['index.js'];                     //core.getInput('excludes');
    //const extensions = ['html', 'htm'];          //core.getInput('extensions')
